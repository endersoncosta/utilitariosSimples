SELECT e.id, e.post_title, e.post_status, e.post_modified, e.post_type, j.post_title as fileTitle, j.guid as fileLink, u.meta_value as unidade, t.meta_value as tipo 
FROM wp_posts e
...
ORDER BY u.meta_value ASC, t.meta_value ASC, e.post_modified DESC
;